...
if ngx.var.host == "static.local" then
...
elseif args.url ~= nil and args.url ~= "" or ngx.var.path ~= nil and ngx.var.path ~= "" then
    ...
    if ngx.var.path ~= nil and ngx.var.path ~="" then
      args.path = ngx.var.content_pwd .. "/" .. ngx.var.path
    end
    
    if ngx.var.width ~= nil and ngx.var.width ~="" then
      args.w = ngx.var.width
    end
    
    if ngx.var.height ~= nil and ngx.var.height ~="" then
      args.h = ngx.var.height
    end
