return {
    -- Template options
    template = {
        name = "API 4 - " .. ngx.var.server_name,
        url = ngx.var.server_name,
        args = "",
        example_image = "image.jpg",
        example_transparent_image = "PNG_transparency_demonstration.png",
        example_smartcrop_image = "image.jpg"
    },

    -- Client options
    client = {
        -- User agent for this client
        user_agent = "Mozilla/5.0 (compatible; ImageFetcher/8.0; +http://static.local/)",
